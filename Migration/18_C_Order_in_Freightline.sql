...
;
-- aber DAS!!
UPDATE AD_Column SET AD_Val_Rule_ID=9000122,Updated=TO_TIMESTAMP('2019-12-22 23:55:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1007612
;
...
UPDATE AD_Column SET IsMandatory='N',Updated=TO_TIMESTAMP('2019-12-03 17:30:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=1007612
;

INSERT INTO t_alter_column values('dd_freightline','C_OrderLine_ID','NUMERIC(10)',null,'NULL')
;

-- correction after adding Sales Order in Freight Line
INSERT INTO AD_View_Column (Help,AD_Client_ID,ColumnName,ColumnSQL,AD_Org_ID,IsActive,AD_View_Column_ID,EntityType,AD_View_ID,AD_Column_ID,Created,CreatedBy,Description,Updated,UpdatedBy,AD_View_Definition_ID,Name) VALUES ('The Order is a control document.  The  Order is complete when the quantity ordered is the same as the quantity shipped and invoiced.  When you close an order, unshipped (backordered) quantities are cancelled.',0,'FL_C_Order_ID','fl.C_Order_ID',0,'Y',1001146,'ZECA',1000010,9008408,TO_TIMESTAMP('2019-12-23 00:05:21','YYYY-MM-DD HH24:MI:SS'),100,'Order',TO_TIMESTAMP('2019-12-23 00:05:21','YYYY-MM-DD HH24:MI:SS'),100,1000016,'Order')
;

UPDATE AD_Browse_Field SET AD_View_Column_ID=1001146,Updated=TO_TIMESTAMP('2019-12-23 00:06:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Browse_Field_ID=1000491
;
