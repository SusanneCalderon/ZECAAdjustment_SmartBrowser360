...
-- tatsächliche AD_Column_ID von Spalte C_OrderLine_ID der Tabelle DD_FreightLine setzen 
UPDATE AD_Column SET Callout='@Script:groovy:updateFreightLine',Updated=TO_TIMESTAMP('2019-12-03 19:24:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID= 1007612
;
...
-- Tabelle DD_FreightLine, Spalte M_Prouduct_ID : Search + Dynamic Validation = M_Product (Trx)
UPDATE AD_Column SET AD_Val_Rule_ID=231, AD_Reference_ID=30,Updated=TO_TIMESTAMP('2019-12-23 02:12:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=84243
;
